...
#[ORM\Entity(repositoryClass: EnPresentationRepository::class)]
#[ORM\HasLifecycleCallbacks]
class EnPresentation
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    public function getType(): ?EnType
    {
        return $this->type;
    }

    public function setType(?EnType $type): self
    {
        $this->type = $type;
